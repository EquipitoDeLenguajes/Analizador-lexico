        ...
        for j in range(len(tokensFinales[i])):
            ...
            if tokensFinales[i][j][0]in character_special:
                ...
                tokenClasificado.append(objeto)
                    ...
                    tokenClasificado.append(objeto)
            elif (tokensFinales[i][j][0][0].isalpha() or tokensFinales[i][j][0][0] == '_') and all(caracter.isalnum() or caracter == '_' for caracter in tokensFinales[i][j][0]):
